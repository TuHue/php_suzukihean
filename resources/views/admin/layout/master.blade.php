                ...
                <ul class="navbar-nav mr-lg-2">
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link" href="#" data-toggle="dropdown" id="profileDropdown">
                            <img src="{{ URL::asset('admin/images/faces/face5.jpg') }}" alt="profile" />
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#quan-ly-xe" aria-expanded="false"
                            aria-controls="quan-ly-xe">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#quan-ly-don-hang" aria-expanded="false"
                            aria-controls="quan-ly-don-hang">
                            <i class="typcn typcn typcn-folder menu-icon"></i>
